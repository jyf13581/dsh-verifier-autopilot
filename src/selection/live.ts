...
function taskPathHints(task: string): string[] {
  ...
  // POSIX absolute paths need their own boundary-aware form. Without it, a
  // Linux host silently misses an explicitly referenced second repository and
  // may snapshot the session repository instead.
